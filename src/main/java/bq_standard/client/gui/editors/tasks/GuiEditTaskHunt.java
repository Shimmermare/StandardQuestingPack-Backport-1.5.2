...
public class GuiEditTaskHunt extends GuiScreenCanvas
{
    ...
    public void initPanel()
    {
        ...
        cvBackground.addPanel( new PanelTextField<Integer>(new GuiTransform(GuiAlign.MID_CENTER, 0, 0, 100, 16, 0), "" + task.required, FieldFilterNumber.INT).setCallback(new ICallback<Integer>() {
            @Override
